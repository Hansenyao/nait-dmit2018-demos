...
InvoiceLines
	.Where(line => line.Invoice.DateKey.Month == new DateTime(2023, 02, 01).Month &&
				   line.ReturnQuantity > 6)
	.Select(line => new {
		InvoiceDate = line.Invoice.DateKey.Date,
		Customer = line.Invoice.Customer.FirstName + " " + line.Invoice.Customer.MiddleName + " " + line.Invoice.Customer.LastName,
